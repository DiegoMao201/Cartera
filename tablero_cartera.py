...
# ======================================================================================
# --- CLASE PDF PERSONALIZADA (PARA GENERAR ESTADOS DE CUENTA) ---
# ======================================================================================
class PDF(FPDF):
    def header(self):
        ...
        # Título: Ahora alineado a la derecha y sin superponerse
    ...
    def footer(self):
        # El pie de página con el link de pago
        self.set_y(-35)
        self.set_font('Arial', 'B', 11)
        self.set_text_color(0, 0, 0) # Color de texto normal
        ...
        self.set_text_color(4, 88, 167) # Un azul corporativo
...
# Definición de Zonas por Grupo de Serie
ZONAS_SERIE = {
...
def procesar_cartera(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Lógica de asignación de zona robusta
