...
columnas_a_ocultar = ['provincia', 'telefono1', 'telefono2', 'entidad_autoriza', 'e-mail', 'descuento', 'cupo_aprobado', 'castigada', 'edad_cartera', 'nomvendedor', 'nomvendedor_norm'] # Ocultamos también la columna normalizada
