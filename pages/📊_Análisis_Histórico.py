# ======================================================================================
# ARCHIVO: pages/📊_Análisis_Histórico.py (Versión Completa y Corregida)
# ======================================================================================
...
if diferencia_flujo >= 0:
    ...
    st.warning(f"**⚠️ Crecimiento de Cartera:** Las ventas superaron a los cobros por **${abs(diferencia_flujo):,.0f}**.")
if dso_periodo <= 30:
