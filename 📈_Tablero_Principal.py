...
def footer(self):
    ...
    link = "[https://ferreinoxtiendapintuco.epayco.me/recaudo/ferreinoxrecaudoenlinea/](https://ferreinoxtiendapintuco.epayco.me/recaudo/ferreinoxrecaudoenlinea/)"
                ...
                if st.button("📧 Enviar Correo con Estado de Cuenta"):
                    if not email_destino or email_destino == 'Correo no disponible' or '@' not in email_destino:
                        ...
                        try:
                            ...
                            portal_link = "[https://ferreinoxtiendapintuco.epayco.me/recaudo/ferreinoxrecaudoenlinea/](https://ferreinoxtiendapintuco.epayco.me/recaudo/ferreinoxrecaudoenlinea/)"
                                    ...
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; border-collapse: collapse;">
                                        ...
                                        <tr>
                                            <td bgcolor="#f4f4f4" style="padding: 25px; text-align: center; border-top: 1px solid #dddddd; font-size: 13px; color: #555555; line-height: 1.5;">
                                                ...
                                                Armenia <a href="[https://wa.me/573165219904](https://wa.me/573165219904)" style="color:#0058A7;">316 5219904</a> ● Manizales <a href="[https://wa.me/573108501359](https://wa.me/573108501359)" style="color:#0058A7;">310 8501359</a> ● Pereira <a href="[https://wa.me/573142087169](https://wa.me/573142087169)" style="color:#0058A7;">314 2087169</a><br><br>
                                                Síguenos en
                                                <a href="[https://www.instagram.com/FerreinoxTiendapintuco](https://www.instagram.com/FerreinoxTiendapintuco)" style="color: #0058A7; text-decoration: none;">Instagram</a> y
                                                <a href="[https://www.facebook.com/FerreinoxTiendapintuco](https://www.facebook.com/FerreinoxTiendapintuco)" style="color: #0058A7; text-decoration: none;">Facebook</a>
                                            </td>
                                        </tr>
                                    </table>
                                </body>
            ...
            with col_whatsapp:
                ...
                if not facturas_vencidas_cliente.empty:
                    ...
                    mensaje_whatsapp = (
                        ...
                        f"🔗 [https://ferreinoxtiendapintuco.epayco.me/recaudo/ferreinoxrecaudoenlinea/](https://ferreinoxtiendapintuco.epayco.me/recaudo/ferreinoxrecaudoenlinea/)\n\n"
                ...
                if numero_limpio:
                    url_whatsapp = f"[https://wa.me/](https://wa.me/){numero_limpio}?text={mensaje_codificado}"
