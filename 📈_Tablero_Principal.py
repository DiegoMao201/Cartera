# ======================================================================================
# ARCHIVO: 📈_Tablero_Principal.py (v.Final con Carga Híbrida)
# ======================================================================================
...
def cargar_datos_desde_dropbox():
    ...
    try:
        ...
        with dropbox.Dropbox(app_key=APP_KEY, app_secret=APP_SECRET, oauth2_refresh_token=REFRESH_TOKEN) as dbx:
            ...
            # Nombres de columna que coinciden con el orden de la consulta SQL final
...
def cargar_datos_historicos():
    ...
    if not archivos_historicos:
        st.info("No se encontraron archivos históricos locales (ej. Cartera_2025_07.xlsx).")
        return pd.DataFrame()
    ...
    for archivo in archivos_historicos:
        try:
            ...
            if not df_hist.empty and "Total" in str(df_hist.iloc[-1, 0]):
