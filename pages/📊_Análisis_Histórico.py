# ======================================================================================
# ARCHIVO: pages/📊_Análisis_Histórico.py (Versión Definitiva y Corregida)
# ======================================================================================
...
if not df_final_graficos.empty:
    ...
    if len(df_final_graficos) > 1:
        ...
        if cambio_dso < -1:
            ...
            st.warning(f"**Tendencia a Revisar:** La eficiencia de cobro ha **disminuido**. Ahora se tarda en promedio **{cambio_dso:.0f} días más** en cobrar que al inicio del período.")
        else:
