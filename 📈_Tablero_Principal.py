                        ...
                        if not email_destino or email_destino == 'Correo no disponible' or '@' not in email_destino:
                            ...
                            try:
                                ...
                                if total_vencido_cliente > 0:
                                    ...
                                    # --- [INICIO PLANTILLA MODIFICADA] HTML PARA CLIENTES CON DEUDA ---
                                    cuerpo_html = f"""
                                    <!DOCTYPE html>
                                    <html lang="es">
                                    <head>
                                            ...
                                            <table width="600" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
                                              <tr>
                                                <td align="center" style="background-color: #003865; padding: 20px;">
                                                  <h1 style="color: #ffffff; font-size: 22px; font-weight: 600; margin: 0;">Recordatorio de Saldo Pendiente</h1>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td style="padding: 20px 25px 15px 25px;">
                                                  <p style="font-size: 15px; color: #333333; margin: 0 0 12px 0;">Hola, <strong>{cliente_seleccionado}</strong> 👋</p>
                                                  <p style="font-size: 14px; color: #555555; line-height: 1.5; margin: 0 0 15px 0;">Te contactamos para recordarte amablemente sobre tu estado de cuenta. Hemos identificado un saldo vencido y te invitamos a revisarlo para mantener tu cuenta al día.</p>
                                                  
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #fdf2f2; border: 1px solid #f0cccc; border-radius: 8px; text-align: center; margin-bottom: 15px;">
                                                    <tr>
                                                      <td style="padding: 12px 15px;">
                                                        <div style="font-size: 11px; color: #c30000; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 4px;">VALOR TOTAL VENCIDO</div>
                                                        <div style="font-size: 30px; color: #c30000; font-weight: 700; margin-bottom: 6px; line-height: 1;">${total_vencido_cliente:,.0f}</div>
                                                        <div style="font-size: 12px; color: #a30000; background-color: #fbe5e5; padding: 4px 8px; border-radius: 4px; display: inline-block;">
                                                          ℹ️ Tu factura más antigua tiene <strong>{dias_max_vencido} días</strong> de vencimiento
                                                        </div>
                                                      </td>
                                                    </tr>
                                                  </table>
                                                  
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #eaf6ff; border: 1px solid #bde0ff; border-radius: 8px; text-align: left; margin-bottom: 15px;">
                                                    <tr>
                                                      <td style="padding: 10px 15px; font-size: 14px; color: #005a99;">
                                                     ...
                                                     <tr>
                                                        <td align="center" style="padding: 10px 0;">
                                                            <table border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td align="center" bgcolor="#0058A7" style="border-radius: 8px;">
                                                                        <a href="{portal_link}" target="_blank" style="font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; border-radius: 8px; padding: 12px 25px; display: inline-block;">
                                              ...
                                              <tr>
                                                <td align="center" style="background-color: #f8f9fa; padding: 15px 20px;">
                                                  <div style="color: #6c757d; font-size: 12px;">
                                                    <p style="margin: 0 0 5px 0;">Si ya realizaste el pago, por favor omite este mensaje.</p>
                                                    <p style="margin: 0;">Área de Cartera y Recaudos - Ferreinox SAS BIC</p>
                                                  </div>
                                                </td>
                                              </tr>
                                            </table>
                                    ...
                                    """
                                    # --- [FIN PLANTILLA MODIFICADA] ---
                                else:
                                    asunto = f"Estado de Cuenta Actualizado - {cliente_seleccionado}"
                                    # --- [INICIO PLANTILLA MODIFICADA] HTML PARA CLIENTES AL DÍA ---
                                    cuerpo_html = f"""
                                    <!DOCTYPE html>
                                    <html lang="es">
                                    <head>
                                      <meta charset="UTF-8">
                                      <meta name="viewport" content="width=device-width, initial-scale=1.0">
                                      <title>Estado de Cuenta Actualizado</title>
                                    </head>
                                    <body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #f4f4f4;">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #f4f4f4;">
                                        <tr>
                                          <td align="center" style="padding: 15px 10px;">
                                            <table width="600" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
                                              <tr>
                                                <td align="center" style="background-color: #003865; padding: 20px;">
                                                  <h1 style="color: #ffffff; font-size: 22px; font-weight: 600; margin: 0;">Estado de Cuenta Actualizado</h1>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td style="padding: 20px 25px 15px 25px;">
                                                  <p style="font-size: 15px; color: #333333; margin: 0 0 12px 0;">Hola, <strong>{cliente_seleccionado}</strong> ✨</p>
                                                  <p style="font-size: 14px; color: #555555; line-height: 1.5; margin: 0 0 15px 0;">Recibe un cordial saludo del equipo de <strong>Ferreinox SAS BIC.</strong></p>
                                                  
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #28a745; border-radius: 8px; text-align: center; margin-bottom: 15px;">
                                                    <tr>
                                                      <td style="padding: 20px 15px;">
                                                        <div style="font-size: 24px; color: #ffffff; font-weight: 700; margin-bottom: 5px;">🎉 ¡Felicitaciones!</div>
                                                        <p style="color: #ffffff; font-size: 16px; margin: 0 0 5px 0;">Tu cuenta no presenta saldos vencidos.</p>
                                                        <p style="color: #ffffff; font-size: 13px; margin: 0;">Agradecemos enormemente tu puntualidad y excelente gestión de pagos.</p>
                                                      </td>
                                                    </tr>
                                                  </table>
                                                  
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #eaf6ff; border: 1px solid #bde0ff; border-radius: 8px; text-align: left;">
                                                    <tr>
                                                      <td style="padding: 10px 15px; font-size: 14px; color: #005a99;">
